 ...
 *  <p>
 *  Usage: {@code java -mx400m -cp "*" NER [serializedClassifier [fileName]] }
 *  <p>
 *  If arguments aren't specified, they default to
 *  classifiers/english.all.3class.distsim and some hardcoded sample text.
...
//  static String serializedClassifier= "./res/raw/english.all.3class.distsim";
//  static Properties properties = new Properties();
//
//

  public NER(Context context) throws Exception {

//      ConfigReader config = new ConfigReader(context);
//
//
////      File f = new File(getCacheDir()+"/english.all.3class.distsim");
////      if (!f.exists()) try {
////
////        InputStream is = context.getAssets().open("english.all.3class.distsim");
...
//     // serializedClassifier = config.getStr(PROPERTIES.Classifier);
//
//      //properties=config.getProperties();
//
//     // InputSource is = new InputSource(context.openFileInput(serializedClassifier));
//    //InputStream fis = context.getAssets().open(serializedClassifier);
//
//   // serializedClassifier = context.getp()+"/english.all.3class.distsim";
////    InputStream XmlFileInputStream = context.getResources().openRawResource(R.raw.english);
...
////
////    }
//  // System.out.println(outputStream.toString());// getting XML
//
//
...
//        throw new TestException("No Classifier Found!");
//      } else {
//
//      }
//
